...
let randAdj=adj[Math.floor(Math.random()*adj.length)].toLowerCase().split(" ").map(word=>word.charAt(0).toUpperCase()+word.slice(1)).join(" ")
let randNoun=noun[Math.floor(Math.random()*noun.length)].toLowerCase().split(" ").map(word=>word.charAt(0).toUpperCase()+word.slice(1)).join(" ")
let data={
