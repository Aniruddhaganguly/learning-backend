...
const particularJoke=jokes.find((joke)=>joke.id===id)
res.json(particularJoke)
})
...
app.patch('/jokes/:id',(req,res)=>{
  ...
  const newJoke={
    id:id,
    jokeText:req.body.jokeText || particularJoke.jokeText,
    jokeType:req.body.jokeType || particularJoke.jokeType,
  }
  const searchIndex=jokes.findIndex((joke)=>joke.id===id)
